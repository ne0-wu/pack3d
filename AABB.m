classdef AABB
    ...
    methods
        ...
        function [overlapStatus, overlapVolume, minDist] = checkAabbOverlap(obj1,obj2)
            ...
            if overlapStatus
                ...
                overlapVolume = 0;
                sgn = @(x) max(x, 0);
                minDist = norm([sgn(min(obj1.maxX,obj2.maxX) - max(obj1.minX,obj2.minX)), ...
                                sgn(min(obj1.maxY,obj2.maxY) - max(obj1.minY,obj2.minY)), ...
                                sgn(min(obj1.maxZ,obj2.maxZ) - max(obj1.minZ,obj2.minZ))]);
            end
        end
